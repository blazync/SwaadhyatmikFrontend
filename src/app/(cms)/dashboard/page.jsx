...
const Dashboard = () => {
  ...
  {/* Card 1 */}
  <div style={{ backgroundColor: '#f0f0f0', padding: '20px', borderRadius: '5px', width: '30%', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', transition: 'box-shadow 0.3s', cursor: 'pointer' }}>
  ...
  <div style={{ backgroundColor: '#f0f0f0', padding: '20px', borderRadius: '5px', width: '30%', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', transition: 'box-shadow 0.3s', cursor: 'pointer' }}>
    ...
    <p style={{ margin: '0' }}>Content for card 3</p>
      ...
      {/* Google Calendar */}
      {showCalendar && (
        <div style={{ width: '100%', height: '500px', backgroundColor: '#f0f0f0', borderRadius: '5px', marginTop: '20px' }}>
