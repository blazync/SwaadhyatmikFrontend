  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (response.ok && data.success === "Successful Registration") {
          ...
          // Show alert or handle error message
      ...
      <div className="flex-1">
        <div className="text-center">
          <Image
            ...
            height={400}
          />
          <h1 className="text-4xl font-bold mt-4">Weclome to Swaadhyatmik!</h1>
          <p className="text-gray-500">Signup to Get Started with Swaadhyatmik Services</p>
        </div>
      </div>
      {/* Right side */}
      <div className="flex-1">
...
{formik.touched.profile_img && formik.errors.profile_img ? (
  <p className="text-red-500 text-sm mt-1">{formik.errors.profile_img}</p>
) : null}
</div>
